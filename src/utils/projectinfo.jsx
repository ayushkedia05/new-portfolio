const projects = [
  {
    name: "BurnCal",
    description:
      "Built a web application where users can upload images of food. An ML model will identify the food, and with the use of an api we provide nutritional values and also suggest a meal for the required calories.",
    github: "https://github.com/ayushkedia05/ieeeBurnCal",
  },
  {
    name: "Dream It",
    description:
  ...
  },
  {
    ...
    description: `Built an online judge(compiler) with the help of nodejs and reactjs that can compile C, C++, python, and javascript programs at
