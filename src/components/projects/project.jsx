...
import projects from "../../utils/projectinfo.jsx";
  ...
  return (
    <div className="max-w-md  p-6 bg-white border border-gray-200 rounded-lg shadow ">
      ...
      <div className="items-center flex justify-center">
        <a
          href={`${github}`}
          className="flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-slate-700 rounded-lg hover:bg-slate-900 focus:ring-4 focus:outline-none focus:ring-blue-300"
        >
          Github
          <svg
            aria-hidden="true"
  ...
  return (
    <div name="Projects" className="bg-slate-100">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-[70%] ">
        <h2 class="mb-14 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">
          MY WORKS
        </h2>
