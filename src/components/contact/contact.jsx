                ...
                <div className='py-8 lg:py-16 px-4 mx-auto max-w-screen-md'>
                    ...
                    <form className='space-y-8'>
                        <div>
                            ...
                            <input type="text" id="name" className='bg-gray-50 border p-2.5 w-full border-gray-300 text-gray-900 text-sm rounded-lg focus:border-primary-500'></input>
                        </div>
                        <div>
                            <label for="email" className='block mb-2 text-sm font-medium text-gray-700'>Email</label>
                            <input type="email" id="email" className='bg-gray-50 border w-full p-2.5 border-gray-300 text-gray-900 text-sm rounded-lg focus:border-primary-500'></input>
                        </div>

                        <div>
                            <label for="Subject" className='block mb-2 text-sm font-medium text-gray-700'>Subject</label>
                            <input type="text" id="subject" className='bg-gray-50 border w-full p-2.5 border-gray-300 text-gray-900 text-sm rounded-lg focus:border-primary-500'></input>
                        </div>
                        <div>
                            <div >
                                <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Your message</label>
                                <textarea id="message" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="write your message..."></textarea>
                            </div>
                        </div>
